...
public class ArgumentConstraints {
    private final LinkedHashMap<String, ArgumentConstraint> constraints;
    ...
    public ArgumentConstraints(@NotNull final LinkedHashMap<String, ArgumentConstraint> constraints) {
