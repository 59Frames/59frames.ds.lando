...
public class Constraint {
    ...
    public Constraint(@NotNull final String key) {
        this(key, false);
    }

    public Constraint(@NotNull final String key, final boolean isRequired) {
        this(key, isRequired, STRING);
    }

    public Constraint(@NotNull final String key, @NotNull final Predicate<String> predicate) {
        this(key, false, predicate);
    }

    public Constraint(@NotNull final String key, final boolean isRequired, @NotNull final Predicate<String> predicate) {
        this.key = key;
